...
#include "CustomAutoConnectSettings.h"
#include "LinkManager.h"

#include <QQmlEngine>
#include <QtQml>

DECLARE_SETTINGGROUP(CustomAutoConnect, "LinkManager")
{
    qmlRegisterUncreatableType<CustomAutoConnectSettings>("QGroundControl.SettingsManager", 1, 0, "CustomAutoConnectSettings", "Reference only"); \
}

DECLARE_SETTINGSFACT(CustomAutoConnectSettings, autoConnectUDP)
DECLARE_SETTINGSFACT(CustomAutoConnectSettings, udpListenPort)
DECLARE_SETTINGSFACT(CustomAutoConnectSettings, udpTargetHostIP)
DECLARE_SETTINGSFACT(CustomAutoConnectSettings, udpTargetHostPort)
DECLARE_SETTINGSFACT(CustomAutoConnectSettings, nmeaUdpPort)

DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectPixhawk)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectSiKRadio)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectPX4Flow)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectRTKGPS)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectLibrePilot)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectNmeaPort)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectNmeaBaud)
{
...
DECLARE_SETTINGSFACT_NO_FUNC(CustomAutoConnectSettings, autoConnectZeroConf)
{
