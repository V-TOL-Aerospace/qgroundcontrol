...
const char* CustomLinkManager::_defaultUDPLinkName =                  "UDP Link (AutoConnect)";
const char* CustomLinkManager::_mavlinkForwardingLinkName =           "MAVLink Forwarding Link";
const char* CustomLinkManager::_mavlinkForwardingSupportLinkName =    "MAVLink Support Forwarding Link";

const int CustomLinkManager::_autoconnectUpdateTimerMSecs =   1000;
#ifdef Q_OS_WIN
// Have to manually let the bootloader go by on Windows to get a working connect
const int CustomLinkManager::_autoconnectConnectDelayMSecs =  6000;
#else
const int CustomLinkManager::_autoconnectConnectDelayMSecs =  1000;
#endif

CustomLinkManager::CustomLinkManager(QGCApplication* app, QGCToolbox* toolbox)
    : QGCTool(app, toolbox)
    ...
    #endif
{
    qmlRegisterUncreatableType<CustomLinkManager>         ("QGroundControl", 1, 0, "CustomLinkManager",         "Reference only");
    qmlRegisterUncreatableType<LinkConfiguration>   ("QGroundControl", 1, 0, "LinkConfiguration",   "Reference only");
    qmlRegisterUncreatableType<LinkInterface>       ("QGroundControl", 1, 0, "LinkInterface",       "Reference only");
}

CustomLinkManager::~CustomLinkManager()
{
#ifndef __mobile__
#ifndef NO_SERIAL_LINK
    delete _nmeaPort;
...
void CustomLinkManager::setToolbox(QGCToolbox *toolbox)
{
    ...
    connect(&_portListTimer, &QTimer::timeout, this, &CustomLinkManager::_updateAutoConnectLinks);
    _portListTimer.start(_autoconnectUpdateTimerMSecs); // timeout must be long enough to get past bootloader on second pass

}

// This should only be used by Qml code
void CustomLinkManager::createConnectedLink(LinkConfiguration* config)
{
...
bool CustomLinkManager::createConnectedLink(SharedLinkConfigurationPtr& config, bool isPX4Flow)
{
    ...
    if (link) {
        ...
        connect(link.get(), &LinkInterface::disconnected,        this,                &CustomLinkManager::_linkDisconnected);
...
SharedLinkInterfacePtr CustomLinkManager::mavlinkForwardingLink()
{
...
SharedLinkInterfacePtr CustomLinkManager::mavlinkForwardingSupportLink()
{
    for (auto& link : _rgLinks) {
        SharedLinkConfigurationPtr linkConfig = link->linkConfiguration();
...
void CustomLinkManager::disconnectAll(void)
{
...
void CustomLinkManager::_linkDisconnected(void)
{
